...
export default function ClosingCTA() {
  ...
  return (
    ...
    >
      ...
      <motion.span
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 flex items-center justify-center whitespace-nowrap text-[clamp(4rem,17vw,15rem)] font-black leading-none tracking-crush text-mist"
